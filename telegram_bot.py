...
from modules.admin_commands import handle_add_email, handle_ban_email, handle_remove_email, handle_check_email, handle_my_id_command
...
async def post_init(app: Application):
    ...
    logger.debug("Background task check_user_inactivity_loop started")
...
def run_telegram_bot():
    ...
    app.add_handler(CommandHandler(["add_email", "add_users", "add_user"], handle_add_email))
    app.add_handler(CommandHandler("ban_email", handle_ban_email))
    app.add_handler(CommandHandler(["remove_email", "remove_users", "remove_user"], handle_remove_email))
    app.add_handler(CommandHandler(["check_email", "check_user"], handle_check_email))
